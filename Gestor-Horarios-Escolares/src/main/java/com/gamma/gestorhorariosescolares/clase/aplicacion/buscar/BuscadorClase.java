package com.gamma.gestorhorariosescolares.clase.aplicacion.buscar;
...
public class BuscadorClase implements ServicioBuscador<Clase> {
    ...
    public BuscadorClase(ClaseRepositorio repositorio) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> igual(String campo, String valor) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> diferente(String campo, String valor) {
        filtros.add(Filter.create(campo, "!=", valor));
        return this;
    }
     ...
     */
    @Override
    public ServicioBuscador<Clase> mayorQue(String campo, String valor) {
        filtros.add(Filter.create(campo, ">", valor));
        return this;
    }
     ...
     */
    @Override
    public ServicioBuscador<Clase> mayorIgualQue(String campo, String valor) {
        filtros.add(Filter.create(campo, ">=", valor));
        return this;
    }
     ...
     */
    @Override
    public ServicioBuscador<Clase> menorQue(String campo, String valor) {
        filtros.add(Filter.create(campo, "<", valor));
        return this;
    }
     ...
     */
    @Override
    public ServicioBuscador<Clase> menorIgualQue(String campo, String valor) {
        filtros.add(Filter.create(campo, "<=", valor));
        return this;
    }
     ...
     */
    @Override
    public ServicioBuscador<Clase> contiene(String campo, String valor) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> noContiene(String campo, String valor) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> ordenarAscendente(String campo) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> ordenarDescendente(String campo) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> esObligatorio() {
        if (!filtros.isEmpty())
     ...
     */
    @Override
    public ServicioBuscador<Clase> esOpcional() {
        if (!filtros.isEmpty())
     ...
     */
    @Override
    public ServicioBuscador<Clase> intervalo(int intervalo) {
     ...
     */
    @Override
    public ServicioBuscador<Clase> limite(int limite) {
     ...
     */
    @Override
    public Clase buscarPrimero() throws RecursoNoEncontradoException {
        Criteria criterio = new Criteria(new Filters(filtros), ordenador, intervalo, limite);
        List<Clase> listaClases = repositorio.buscar(criterio);
        ...
        if (listaClases.isEmpty())
            throw new RecursoNoEncontradoException("No se encontró la clase.");
        return listaClases.get(0);
    }
